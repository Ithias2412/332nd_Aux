...
force force TAS_lcLoadDist = 30;
force force TAS_lcLoadSpeed = 30;
...
// ACE Casings
force force ace_casings_enabled = false;
...
// ACE Fortify
force force ace_fortify_markObjectsOnMap = 2;
...
grenades_hatches_main_allowedBehaviorSetting = "[""CARELESS"",""SAFE"",""AWARE"",""COMBAT"",""STEALTH""]";
grenades_hatches_main_allowedGrenadesSetting = "[""HandGrenade"",""MiniGrenade""]";
grenades_hatches_main_autodetectGrenadesSetting = true;
grenades_hatches_main_blacklistVehiclesInheritanceSetting = "[]";
grenades_hatches_main_blacklistVehiclesSetting = "[]";
grenades_hatches_main_damageDealtCrew = 5;
grenades_hatches_main_damageDealtCrewVanilla = 0.25;
grenades_hatches_main_damageDealtEngine = 1;
grenades_hatches_main_damageDealtEngineMax = 1;
grenades_hatches_main_damageDealtHull = 0.75;
grenades_hatches_main_damageDealtHullMax = 0.75;
grenades_hatches_main_damageDealtTurret = 1;
grenades_hatches_main_damageDealtTurretMax = 1;
grenades_hatches_main_damageType = true;
grenades_hatches_main_delayExplosion = 5;
grenades_hatches_main_delayInteraction = 3;
grenades_hatches_main_disablePlayerAmbush = true;
grenades_hatches_main_distanceInteraction = 10;
grenades_hatches_main_enableKnowledgeMultiplier = false;
grenades_hatches_main_forceCrewDismount = false;
grenades_hatches_main_killCrewIfVehicleExplodes = false;
grenades_hatches_main_knowledgeMultiplier = 5;
grenades_hatches_main_whitelistVehiclesInheritanceSetting = "[""Tank"",""Wheeled_Apc_F""]";
grenades_hatches_main_whitelistVehiclesSetting = "[]";
...
ace_interact_menu_more__332nd_ace_mainAction = false;
...
ace_interact_menu_more__danceParty = false;
...
ace_interact_menu_moveToRoot__332nd_ace_mainAction__332nd_ace_nvSettings = false;
ace_interact_menu_moveToRoot__332nd_ace_mainAction__332nd_ace_nvSettings__332nd_ace_nv_custom = false;
ace_interact_menu_moveToRoot__332nd_ace_mainAction__332nd_ace_nvSettings__332nd_ace_nv_decrease = false;
ace_interact_menu_moveToRoot__332nd_ace_mainAction__332nd_ace_nvSettings__332nd_ace_nv_increase = false;
ace_interact_menu_moveToRoot__332nd_ace_mainAction__332nd_ace_nvSettings__332nd_ace_nv_toggle = false;
...
ace_interact_menu_moveToRoot__ACE_Equipment__SCH_Unpack__SCH_Unpack_332nd_Prowler_Drone = false;
...
force force ace_medical_limbDamageThreshold = 0.5;
...
force force ace_medical_treatment_cprSuccessChanceMin = 0.25;
...
force force ace_medical_treatment_treatmentTimeCPR = 8;
...
force ace_medical_treatment_treatmentTimeTrainedAutoinjector = 4;
force ace_medical_treatment_treatmentTimeTrainedIV = 8;
force ace_medical_treatment_treatmentTimeTrainedSplint = 8;
force ace_medical_treatment_treatmentTimeTrainedTourniquet = 4;
...
force ace_repair_engineerSetting_wheel = 1;
...
force AR_DefaultAnimationPlayed = "ARMA_AlternativeRun_WW2Style";
...
// Arcade Medical
force acearcade_arcademedical_medicalBandageMinTime = 2.25;
force acearcade_arcademedical_medicalBandageTreatmentTime = 1;

// Arcade Unconscious
force force acearcade_arcadeunconscious_unconsciousEnableInput = true;
force force acearcade_arcadeunconscious_unconsciousRadioVolume = 1;
force force acearcade_arcadeunconscious_unconsciousRemovePostProcessing = true;
force force acearcade_arcadeunconscious_unconsciousSpeakingVolume = 1;
...
force force crowsza_zeus_text_CBA_Setting_rc_helper = true;
...
force force DBA_SuperTacticalDroidBuff = false;
force DBA_SuperTacticalDroidBuffOther = 2;
force DBA_TacticalBuffLevel = 0.85;
force force DBA_TacticalDroidBuff = false;
...
force WBK_DeathAnimMod_Deaths_Dismember = false;
force WBK_DeathAnimMod_Deaths_Dismember_Num = "20";
...
// Galactic Turmoil
GTM_alarm_debug = false;
GTM_elevator_debug = false;
GTM_elevator_doorDwellTime = 5;
GTM_elevator_travelMultiplier = 1;
GTM_shared_debug = false;
...
force WBK_HWF_WeapsArraySetting = "['MMG_01_hex_F','332nd_Z6','MMG_01_hex_ARCO_LP_F','MMG_01_tan_F','MMG_02_black_F','MMG_02_black_RCO_BI_F','MMG_02_sand_F','MMG_02_sand_RCO_LP_F','MMG_02_camo_F','OPTRE_M247H_Etilka','OPTRE_M247H_Shield_Etilka','JLTS_Z6','SWLW_Z6','IDA_Z6','HLC_wp_M134Painless']";

// Hide Among The Grass
force force hatg_setting_building = false;
force hatg_setting_complex_detection = false;
force hatg_setting_cooldown = 120;
...
force hatg_setting_distance_close = 10;
...
force force hatg_setting_reveal_nearby = true;
...
force ls_activecamo_cooldown = 30;
force ls_activecamo_enabled = true;
force ls_activecamo_maxAllowedHits = 1;
...
ls_map_objectMarkersEnabled = true;
ls_map_objectMarkersShowName = true;
...
force force OPTRE_MJOLNIR_SHIELD_ENERGY = 100;
...
force force OPTRE_MJOLNIR_SPEED_MODIFIER = 1.3;
...
force TKE_Ext_EuropaFogEnabled = true;
force TKE_Ext_EuropaGeysirsEnabled = true;
force TKE_Ext_EVAHelmetRequired = true;
force TKE_Ext_EVAHelmets = "TKE_MDPilotHelmRVMarineNoPipes,  TKE_MDPilotHelmRVMarine,  TKE_MDPilotHelmRVNoPipes,  TKE_MDPilotHelmRV,  TKE_UCNPilotHelmRVUCFANoPipe,  TKE_UCNPilotHelmRVUCFA,  TKE_UCNPilotHelmRVNoPipe,  TKE_UCNPilotHelmRV,  TKE_FCrewHelmCiv,  TKE_MercHelmClosedFCF,  TKE_MercHelmNVG1FCF,  TKE_UCMCHelmClosedFEDRA,  TKE_UCMCHelmClosedFEDRAV2,  TKE_MercHelmClosedFEDRA,  TKE_MercHelmNVG1FEDRA,  TKE_KMCHelm,  TKE_KMCHelmTeeth,  TKE_MercHelmClosedKMC,  TKE_MercHelmNVG1KMC,  TKE_MDTFPilotHelm,  TKE_MDTFPilotHelmSnow,  TKE_WarBotHead,  TKE_WarBotHeadWorker,  TKE_MDTFPilotHelmV2,  TKE_MDTFPilotHelmV2Snow,  TKE_MDTFHeavyHelm,  TKE_MDTFHeavyHelmCamo,  TKE_MDTFHeavyHelmClearCamo,  TKE_MDTFHeavyHelmClear,  TKE_MDTFHeavyHelmSnow,  TKE_MDTFHeavyHelmSnowClear,  TKE_MDTFHelm,  TKE_MDTFHelmClear,  TKE_MDTFHelmCamo,  TKE_MDTFHelmClearCamo,  TKE_MDTFHelmSnow,  TKE_MDTFHelmClearSnow,  TKE_MDTFPilotHelmRed,  TKE_WarBotHeadMDMC,  TKE_MDTFPilotHelmV2Red,  TKE_MDTFHeavyHelmRed,  TKE_MDTFHeavyHelmClearRed,  TKE_MDTFHelmRed,  TKE_MDTFHelmClearRed,  TKE_MDTFHeavyHelmGrey,  TKE_MDTFHeavyHelmClearGrey,  TKE_MDTFHelmGrey,  TKE_MDTFHelmClearGrey,  TKE_WarBotHeadMDTF,  TKE_MercHelmClosed_BASE,  TKE_MercHelmNVG1MercLG,  TKE_MercHelmNVG1_BASE,  TKE_MercHelmClosedMercLG,  TKE_FCrewHelmMD,  TKE_FCrewHelmMDBlue,  TKE_FCrewHelmMDBrown,  TKE_FCrewHelmMDGreen,  TKE_FCrewHelmMDPurple,  TKE_FCrewHelmMDRed,  TKE_FCrewHelmMDWhite,  TKE_FCrewHelmMDYellow,  TKE_UCNPilotHelmNP_Army,  TKE_UCMCHelmMaskV2_Camo2,  TKE_UCMCHelmMaskV2_Army,  TKE_UCMCHelmMaskV2_ArmyV3,  TKE_UCMCHelmMask_Camo2,  TKE_UCMCHelmMask_Army,  TKE_UCMCHelmMask_ArmyV3,  TKE_UCMCHelmClosedCamo2,  TKE_UCMCHelmClosedArmy,  TKE_UCMCHelmClosedArmyV3,  TKE_UCMCHelmClosedCamo2V2,  TKE_UCMCHelmClosedArmyV2,  TKE_UCMCHelmClosedArmyV2V3,  TKE_UCNPilotHelm_Army,  TKE_FCrewHelm_BASE,  TKE_FCrewHelmBlue,  TKE_FCrewHelmBrown,  TKE_FCrewHelmGreen,  TKE_FCrewHelmPurple,  TKE_FCrewHelmRed,  TKE_FCrewHelmWhite,  TKE_FCrewHelmYellow,  TKE_UCMRHelm1st,  TKE_UCMRHelm1stV2,  TKE_UCMCHelmMaskV2_Camo,  TKE_UCMCHelmMask_Camo,  TKE_UCMCHelmClosedCamo1,  TKE_UCMCHelmClosedCamo1V2,  TKE_UCMRHelm,  TKE_UCMRHelmCamo,  TKE_UCMRHelmCamoTeeth,  TKE_UCMRHelmV2,  TKE_UCMRHelmCamoV2,  TKE_UCMRHelmCamoTeethV2,  TKE_UCMRHelmTeethV2,  TKE_UCMRHelmTeeth,  TKE_UCNPilotHelmNP_BASE,  TKE_UCMCHelmMaskV2,  TKE_UCMCHelmMask,  TKE_UCMCHelmMaskSkull,  TKE_UCMCHelmClosed,  TKE_UCMCHelmClosedV2,  TKE_UCNPilotHelm_BASE,  TKE_UCPHelmClosed,  TKE_UCPHelmClosedV2,  H_PilotHelmetFighter_I,  H_PilotHelmetFighter_O,  H_PilotHelmetFighter_B,  H_PilotHelmetFighter_I_E";
force TKE_Ext_EVASaveSurfaces = "#tke_ext_earth, #tke_ext_concrete, #tke_ext_tiles";
force TKE_Ext_EVASuffocationTime = 40;
force TKE_Ext_EVASystemEnabled = true;
force TKE_Ext_EVAUniformRequired = true;
force TKE_Ext_EVAUniforms = "TKE_VoidSuitCiv_U_B,TKE_VoidSuitFCF_U_B,TKE_VoidSuitFEDRA_U_B,TKE_VoidSuitKMC_U_B,TKE_WarbotUni_U_B,TKE_WarbotUniWorker_U_B,TKE_VoidSuitMD_U_B,TKE_WarbotUniMDMC_U_B,TKE_VoidSuitMDMC_U_B,TKE_VoidSuitMDMCV2_U_B,TKE_VoidSuitMDGrey_U_B,TKE_WarbotUniMDTF_U_B,TKE_VoidSuitMerc_U_B,TKE_VoidSuitArmyV2_U_B,TKE_VoidSuitArmyV3_U_B,TKE_VoidSuitArmy_U_B,TKE_VoidSuitCamo_U_B,TKE_VoidSuit_U_B,U_B_PilotCoveralls,U_O_PilotCoveralls,U_I_pilotCoveralls";
force TKE_Ext_EVAWorlds = "TKE_Ext_Ganymede,TKE_Ext_Europa";
force TKE_Ext_MassModifierEuropa = 0.5;
force TKE_Ext_MassModifierEuropaEnabled = false;
force TKE_Ext_MassModifierGanymede = 0.5;
force TKE_Ext_MassModifierGanymedeEnabled = false;
force TKE_Ext_SkyboxBrightness = 1;
force TKE_Ext_SkyboxBrightnessAutoAdjust = true;
force TKE_Ext_SkyboxEnabled = true;
force TKE_Ext_SkyboxWorlds = "TKE_Ext_Ganymede,TKE_Ext_Europa";
...
// WBK Droids
force WBK_Droids_B1_Health = "50";
force WBK_Droids_B2_Health = "300";
force WBK_Droids_BX_Health = "200";
...
force WBK_ZommbiesGoliathHealthParam = "30000";
force WBK_ZommbiesGoliathPickupAttackParam = true;
force WBK_ZommbiesGoliathThrowParam = true;
force WBK_ZommbiesGoliathThrowShardsParam = false;
force WBK_ZommbiesGoliathUndergroundAttackParam = false;
...
force force zen_visibility_maxDistance = 5000;
...
zen_faction_filter_0_332nd_CIS_Faction = true;
zen_faction_filter_0_332nd_CIS_Geonosis_Faction = true;
zen_faction_filter_0_332nd_East_Enia_Faction = true;
zen_faction_filter_0_332nd_East_Enia_Faction_groups = true;
zen_faction_filter_0_332nd_Umbara_Faction = true;
...
zen_faction_filter_0_FCF = true;
zen_faction_filter_0_GUL_Faction = true;
zen_faction_filter_0_IDA_BattleDroids_Faction = true;
zen_faction_filter_0_IDA_CIS = true;
...
zen_faction_filter_0_MD_MDMC = true;
zen_faction_filter_0_MD_MDTF = true;
zen_faction_filter_0_MD_MPDF = true;
...
zen_faction_filter_0_WBK_AI_StarWars_Droids_3AS = true;
zen_faction_filter_0_WBK_AI_ZHAMBIES = true;
zen_faction_filter_1_332nd_Faction = true;
...
zen_faction_filter_1_IDA_REP = true;
...
zen_faction_filter_1_UCN_POLICE = true;
...
zen_faction_filter_2_FCF_IND = true;
zen_faction_filter_2_GUL_Faction = true;
...
zen_faction_filter_2_JMSLLTE_guav_fact = true;
zen_faction_filter_2_JMSLLTE_Guav_fact_groups = true;
zen_faction_filter_2_JMSLLTE_haxBr_fact = true;
zen_faction_filter_2_JMSLLTE_hutt_fact = true;
zen_faction_filter_2_JMSLLTE_hutt_fact_groups = true;
zen_faction_filter_2_JMSLLTE_Jinata_fact = true;
zen_faction_filter_2_JMSLLTE_sawpartisans = true;
zen_faction_filter_2_KMC = true;
...
zen_faction_filter_2_TKE_FEDSEC_Groups_G = true;
zen_faction_filter_2_UCN_FEDRA_G = true;
zen_faction_filter_2_WBK_AI_ZHAMBIES = true;
zen_faction_filter_3_3AS_Civilian = true;
zen_faction_filter_3_CIV = true;
