class CfgPatches
{
	class 332nd_lightingTweaks_nalHutta
	{
		author="Viper";
		name="Nalhutta";
		requiredAddons[]=
		...
		class Weather: Weather
		{
			class LightingNew
			{
				...
				class Lighting7
				{
					...
					ambientMidCloud[]=
					{
						{0.39215699,0.470588,0.39215699},
						6
					};
					groundReflection[]=
					{
					...
					sky[]=
					{
						{0.58823502,0.78431398,0.58823502},
						5
					};
					skyAroundSun[]=
					{
